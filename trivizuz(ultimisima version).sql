...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-07-2020 a las 17:07:50
...
(3, 'Cuphead', '40', 'Cuphead is a classic run and gun action game heavily focused on boss battles. Inspired by cartoons of the 1930s, the visuals and audio are painstakingly created with the same techniques of the era, i.e. traditional hand drawn cel animation, watercolor backgrounds, and original jazz recordings', 9, 0, 1, '3.jpg', 0, 'Aventura'),
(4, 'Fire Emblem Awakening', '96', 'Chrom, the prince of Ylisse, and his personal army, the \"Shepherds\" rescue the player character, or Avatar, who is suffering from amnesia. Over the course of the story, the Avatar aids Chrom\'s army in defending Ylisse from undead monsters - the Risen - and attacks from the hostile nation of Plegia.', 9, 0, 2, '4.jpg', 1, 'Estrategia'),
(5, 'Dark Souls III', '96', 'Dark Souls continues to push the boundaries with the latest, ambitious chapter in the critically-acclaimed and genre-defining series. Prepare yourself and Embrace The Darkness!', 8, 0, 1, '5.jpg', 1, 'Aventura'),
(6, 'Age Of Empires II', '51', 'Age of Empires II: Definitive Edition conmemora el 20 aniversario de uno de los juegos de estrategia más aclamados de todos los tiempos, en una versión que ofrece impactantes gráficos 4K Ultra HD, una pista sonora completamente remasterizada y contenido totalmente nuevo', 7, 0, 2, '6.jpg', 1, 'Estrategia'),
(7, 'Borderlands 3', '80', 'The original shooter-looter returns, packing bazillions of guns and a mayhem-fueled adventure! Blast through new worlds & enemies and save your home from the most ruthless cult leaders in the galaxy.', 8, 0, 1, '7.jpg', 0, 'Accion'),
(8, 'The Sims 4', '70', 'Disfruta el poder de crear y controlar a la gente en un mundo en que todo es posible', 6, 0, 3, '8.jpg', 0, 'Casual'),
(9, 'Pummel Party', '31', 'Pummel Party is a 4-8 player online and local-multiplayer party game. Pummel friends or AI using a wide array of absurd items in the board mode and compete to destroy friendships in the unique collection of minigames', 8, 0, 2, '9.jpg', 0, 'Casual'),
(10, 'Totally Acurate Battle Simulator', '31', 'Totally Accurate Battle Simulator is a wacky physics-based tactics game. Experience accurate warfare through the ages. TABS uses state of the art physics-based simulation to provide you with never-before-seen insight to our greatest battles of history', 6, 0, 1, '10.jpg', 1, 'Casual'),
(11, 'Nintendo 3DS', '443', 'Videoconsola portátil de la multinacional de origen japonés, Nintendo, para videojuegos y multimedia, cuya atracción principal es poder mostrar gráficos en 3D sin necesidad de gafas especiales, gracias a la autoestereoscopia', 7, 1, 3, '11.jpg', 1, 'ninguno'),
(12, 'PS3', '540', 'PS3 en buen estado se encuentra vendiendo en Ebay', 9, 1, 2, '12.jpg', 0, 'ninguno');
